...
/**
 * @brief Init the device. Should be called at the begining
 * 
 ...
 * Send("/dev/xdma0_h2c_0", 0, 1, 0, 0, (int *)(weight_in_bits[0]), 5 * 16);
 * Send("/dev/xdma0_h2c_0", 0, 1, 1, 0, (int *)(weight_in_bits[1]), 5 * 16);
 ...
 * Recv("/dev/xdma0_h2c_0", "/dev/xdma0_c2h_0", 0, 1, 0, 0, (int *)(weight_in_bits), 5 * 16);
 ...
 * // result buffer size should be "in_group * actived_macro_num * 4"
